      ...
      <div className="container-fluid">
        <div className="row mt-5">
          ...
          <div className="col-6 px-5 fs-4 pt-5 mt-2" id="text_about">
            My name is <span style={{ color: "orange" }}>Sulman Thaheem</span>,
            and I am a freelance front-end-web developer and a WordPress developer with a
            ...
            <div className="d-flex justify-content-between mt-5">
              ...
              <a
                href="https://www.linkedin.com/in/sulman-thaheem-625b9a197/"
